    ...
    function ($, Log, Ajax) {
        ...
        Mark.prototype.main = function () {
            ...
            self.rootel.on('click', '#quickmarksave', function (e) {
                ...
                self.regenerateCriterionJSON();
                var avgEngagement = self.regenerateEngagementJSON();
         ...
         * @method
         */
        Mark.prototype.regenerateEngagementJSON = function () {
            var self = this;
            var engagementjson = $('input[name="engagementjson"]');
            var engagements = new Array();
            var avgEngagement = 0;
            var engagementValues = ['', 'E', 'VG', 'A', 'NI'];
            var isnewversion = document.querySelector('.hide-engagement') != null;
            ...
            self.rootel.find('.engagement.tbl-tr').each(function () {
                ...
                avgEngagement = avgEngagement + Number(selectedlevel);
            });
            ...
            var avgEngagementStr = '';

            if (isnewversion) {
                avgEngagement = Math.ceil(avgEngagement / engagements.length);
                avgEngagementStr = engagementValues[avgEngagement];
            }

            return avgEngagementStr;
        };
