...
$string['task:enableweights'] = 'Enable criterion weights';
$string['task:enableweightsdesc'] = 'Allow custom weights for criteria in grade calculations.';
...
$string['remindernoevidencecopy'] = 'Important Notice: The evidence for the selected task(s) will not be imported. If the imported task does not include the new engagement rubric, please update the task accordingly.';
